            ...
            <form action="{{ route('admin.dishes.update', $dish) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="has_cheese_variant" 
                                       ...
                                       {{ old('has_cheese_variant', $dish->has_cheese_variant) ? 'checked' : '' }}
                        ...
                        <div id="cheesePriceSection" class="mb-3" style="{{ old('has_cheese_variant', $dish->has_cheese_variant) ? '' : 'display: none;' }}">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('price_with_cheese') is-invalid @enderror" 
                                       id="price_with_cheese" name="price_with_cheese" value="{{ old('price_with_cheese', $dish->price_with_cheese) }}">
                            </div>
